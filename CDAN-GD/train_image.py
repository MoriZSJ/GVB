...
def image_classification_test(loader, model, bridge=True, test_10crop=True):
    start_test = True
    with torch.no_grad():
        if test_10crop:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--batch_size', type=int, default=36, help="print num ")
    ...
    parser.add_argument('--trade_off', type=float, default=1.0, help="learning rate")
    parser.add_argument('--seed', type=int, default=0, help="random seed number ")
    parser.add_argument('--random', type=bool, default=False, help="whether use random projection")
    parser.add_argument('--GVBD', type=bool, default=False, help="whether use GVBD variable")
    parser.add_argument('--show', type=bool, default=False, help="whether show the loss functions")
    parser.add_argument('--GVBG', type=bool, default=False, help="whether use GVBG variable")
